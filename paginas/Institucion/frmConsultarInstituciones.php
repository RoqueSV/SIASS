...
$query="select idinstitucion, nombreinstitucion, rubro, nombrecontacto from institucion where estadoinstitucion='A';";
...
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td align="center"><h2>INSTITUCIONES VIGENTES</h2>
			  	</td>
			</tr>
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td>
					...
					?>
					<h3 align="center">Click en los datos de una instituci&oacute;n, para ver sus detalles.</h3>
					<table width="90%" align="center" class="marco">
								...
								<table cellpadding="0" cellspacing="0" id="table" class="tinytable">
									<thead class="titulo1">
										<tr>
											...
											<th onMouseOver="toolTip('Ordenar por Instituci&oacute;n',this)" width="35%"><h3>Instituci&oacute;n</h3></th>
											<th onMouseOver="toolTip('Ordenar por Rubro',this)" width="30%"><h3>Rubro</h3></th>
											<th onMouseOver="toolTip('Ordenar por Contacto',this)" width="25%"><h3>Contacto</h3></th>
										</tr>
									</thead>
									<tbody class="subtitulo2">
										...
										?>
										<tr align="center">
											<td><a title='Ver Instituci&oacute;n' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetallesInstitucion.php?id=<?php echo $row[0];?>'"><?php echo $row['idinstitucion'];?></a></td>
											<td><a title='Ver Instituci&oacute;n' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetallesInstitucion.php?id=<?php echo $row[0];?>'"><?php echo $row['nombreinstitucion'];?></a></td>
											<td><a title='Ver Instituci&oacute;n' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetallesInstitucion.php?id=<?php echo $row[0];?>'"><?php echo $row['rubro'];?></a></td>
											<td><a title='Ver Instituci&oacute;n' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetallesInstitucion.php?id=<?php echo $row[0];?>'"><?php echo $row['nombrecontacto'];?></a></td>
										</tr>
										<?php
										}
										?>
						...
						<tr>
							...
							<td>
								...
								<img src="../../imagenes/icono_recargar.png" align="top" onClick="redireccionar('frmConsultarInstituciones.php');" onMouseOver="toolTip('Actualizar',this)" class="manita">
					...
					<table align="center" class="alerta error centro">
						<tr>
							<td align="center" colspan="3">
									No hay instituciones en estado de Alta.<br><br>					
								<img src="../../imagenes/icono_cancelar.png" align="top" onClick="redireccionar('../Inicio/plantilla_pagina.php')" onMouseOver="toolTip('Cancelar, volver al Inicio',this)" class="manita">
							</td>
						</tr>
					</table>
