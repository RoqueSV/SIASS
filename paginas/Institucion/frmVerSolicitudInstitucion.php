...
$query="SELECT idinstitucion, nombreinstitucion, nombrecontacto, cargocontacto 
from institucion where estadoinstitucion='P' order by idinstitucion desc;";
...
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td align="center"><h2>SOLICITUDES DE INSTITUCIONES</h2>
			  	</td>
			</tr>
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td>
					...
					?>
					<h3 align="center">Click en los datos de la solicitud, para ver sus detalles.</h3>
					<table width="90%" align="center" class="marco">
								...
								<table cellpadding="0" cellspacing="0" id="table" class="tinytable">
									<thead class="titulo1">
										<tr>
											...
											<th onMouseOver="toolTip('Ordenar por Cargo',this)" width="30%"><h3>Cargo</h3></th>
										</tr>
									</thead>
									<tbody class="subtitulo2">
										...
										?>
										<tr align="center">
											<td><a title='Ver Solicitud' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmProcesarSolicitud.php?id=<?php echo $row[0];?>'"><?php echo $row[0];?></a></td>
											<td><a title='Ver Solicitud' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmProcesarSolicitud.php?id=<?php echo $row[0];?>'"><?php echo $row[1];?></a></td>
											<td><a title='Ver Solicitud' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmProcesarSolicitud.php?id=<?php echo $row[0];?>'"><?php echo $row[2];?></a></td>
											<td><a title='Ver Solicitud' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmProcesarSolicitud.php?id=<?php echo $row[0];?>'"><?php echo $row[3];?></a></td>
										</tr>
										<?php
										}
										?>
						...
						<tr>
							...
							<td>
								...
								<img src="../../imagenes/icono_recargar.png" align="top" onClick="redireccionar('frmVerSolicitudInstitucion.php');" onMouseOver="toolTip('Actualizar',this)" class="manita">
					...
					<table align="center" class="alerta error centro">
						<tr>
							<td align="center" colspan="3">
									No hay nuevas solicitudes de instituciones.<br><br>					
								<img src="../../imagenes/icono_cancelar.png" align="top" onClick="redireccionar('../Inicio/plantilla_pagina.php')" onMouseOver="toolTip('Cancelar, volver al Inicio',this)" class="manita">
							</td>
						</tr>
					</table>
