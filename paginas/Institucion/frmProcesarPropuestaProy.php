...
<h2 align="center">DETALLE DE PROPUESTA DE PROYECTO (INSTITUCION)</h2>

<form method="post" action="../../archivosphp/ProcesaPropuestaProyectoInst.php?operacion=2">
...
<tr><td id='tdr'><b>CORREO:</b></td><td id='tdl'><a href='mailto:".$row['correocontacto']."'>".$row['correocontacto']."</a></td></tr>
...
<input type="button" value="Regresar" class="buton" onclick="document.location.href='frmConsultarPropuestas.php'">
</center>
</form>
<br><br>
