...
where pp.idpropuesta=".$idpropuesta;
}
...
while($resul=pg_fetch_array($aux))
{
$alumnos.=strtoupper($resul['nombre']).' carné nº '.$resul['carnet'].', ';
}
...
$section->addText('Aprovecho la ocasión para manifestarle que los Bachilleres: '.$alumnos.' 
estudiantes de la carrera de '.$resul['nombrecarrera'].', me han informado su deseo de realizar el servicio social en la 
unidad que usted dignamente dirige, por lo que con todo respeto a usted solicito conceda un espacio para que los Bachilleres 
antes mencionados, puedan desempeñar sus actividades.',null,array('align'=>'both','spacing'=>100));
...
$objWriter->save('cartaAprobacionGrupal.docx');

include '..\..\librerias\cerrar_conexion.php';


$documento = 'cartaAprobacionGrupal.docx'; $nombredoc="Carta de aprobacion de proyecto.docx";
