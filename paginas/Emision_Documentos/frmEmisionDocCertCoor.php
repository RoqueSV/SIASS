...
where pa.estadoalumnoproyecto='F' and revision=1
								...
								<table cellpadding="0" cellspacing="0" id="table" class="tinytable">
									...
									<tbody class="subtitulo2">
										...
										<tr align="center"> <!-- href='.php?id=$row[0]' -->
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoCoor.php?op=2&id=<?php echo $row[0]; ?>'"><?php echo $row['carnet']; ?></a></td>
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoCoor.php?op=2&id=<?php echo $row[0]; ?>'"><?php echo $row['nomalumno']; ?></a></td>
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoCoor.php?op=2&id=<?php echo $row[0]; ?>'"><?php echo $row['totalhoras']; ?></a></td>
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoCoor.php?op=2&id=<?php echo $row[0]; ?>'"><?php echo $row['nombrecarrera']; ?></a></td>
										</tr>
										<?php
										}
										?>
