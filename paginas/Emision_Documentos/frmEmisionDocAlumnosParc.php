								...
								<table cellpadding="0" cellspacing="0" id="table" class="tinytable">
									<thead class="titulo1">
										<tr>
											...
											<th onMouseOver="toolTip('Ordenar por Horas',this)" width="15%"><h3>Horas</h3></th>
									...
									<tbody class="subtitulo2">
										...
										<tr align="center"> <!-- href='.php?id=$row[0]' -->
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoParc.php?id=<?php echo $row[0];?>'"><?php echo $row['carnet'];?></a></td>
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoParc.php?id=<?php echo $row[0];?>'"><?php echo $row['nomalumno'];?></a></td>
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoParc.php?id=<?php echo $row[0];?>'"><?php echo $row['totalhoras'];?></a></td>
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoParc.php?id=<?php echo $row[0];?>'"><?php echo $row['nombrecarrera'];?></a></td>
										</tr>
										<?php
										}
										?>
					...
					<table align="center" class="alerta error centro">
						<tr>
							<td align="center" colspan="3">
									No existen alumnos con horas de servicio asignadas.<br><br>					
