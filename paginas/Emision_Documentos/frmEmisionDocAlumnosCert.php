...
having sum(horas)>=horasrequeridas;";
...
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td align="center"><h2>EMISION DE CERTIFICACION DE FINALIZACION DE SERVICIO SOCIAL</h2>
			  	</td>
			</tr>
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
					...
					<table align="center" class="marco" width="90%">
								...
								<table cellpadding="0" cellspacing="0" id="table" class="tinytable">
									<thead class="titulo1">
										<tr>
											...
											<th onMouseOver="toolTip('Ordenar por Horas',this)" width="10%"><h3>Horas</h3></th>
											<th onMouseOver="toolTip('Ordenar por Carrera',this)" width="40%"><h3>Carrera</h3></th>
									...
									<tbody class="subtitulo2">
										...
										<tr align="center"> <!-- href='.php?id=$row[0]' -->
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoCert.php?id=<?php echo $row[0];?>'"><?php echo $row['carnet'];?></a></td>
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoCert.php?id=<?php echo $row[0];?>'"><?php echo $row['nomalumno'];?></a></td>
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoCert.php?id=<?php echo $row[0];?>'"><?php echo $row['totalhoras'];?></a></td>
											<td><a title='Ver Detalles de Proyecto' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmDetalleAlumnoCert.php?id=<?php echo $row[0];?>'"><?php echo $row['nombrecarrera'];?></a></td>
										</tr>
										<?php
										}
										?>
						...
						<tr>
							...
							<td>
								...
								<img src="../../imagenes/icono_recargar.png" align="top" onClick="redireccionar('frmEmisionDocAlumnosCert.php');" onMouseOver="toolTip('Actualizar',this)" class="manita">
