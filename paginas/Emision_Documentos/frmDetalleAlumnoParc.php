...
<h2 align="center">DETALLES DE ALUMNO</h2>
	...
	<thead><tr><th colspan="2"><h3>INFORMACION</h3></tr></thead>
        ...
        <input type="button" class="buton" name="inicio" value="Regresar"  style="width: 150px" onclick="document.location.href='frmEmisionDocAlumnosParc.php'"/>
		<input type="button" class="buton" name="inicio" value="Generar Constancia"  style="width: 150px" onclick="document.location.href='ConstanciaSS.php?ida=<?php echo $_GET['id']?>'"/>
		</center>
