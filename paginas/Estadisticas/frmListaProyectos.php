			...
			<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
				<tr>
					...
					<tr>
						...
						<th onMouseOver="toolTip('Ordenar por estado',this)" width="5"><h3>Estado</h3></th>
						<th onMouseOver="toolTip('Ordenar por Descripcion',this)" width="70"><h3>Descripci&oacute;n</h3></th>
					</tr>
						</thead>
						<tbody class="subtitulo2">
							<?php
							while ($proyectos = pg_fetch_array($consulta_proyectos)){
								if($proyectos['estado']=='D')$est='DISPONIBLE';
								if($proyectos['estado']=='A')$est='ASIGNADO';
								if($proyectos['estado']=='P')$est='EN PROCESO';
								if($proyectos['estado']=='F')$est='FINALIZADO';
								if($proyectos['estado']=='L')$est='DETENIDO';
								if($proyectos['estado']=='B')$est='DE BAJA';
							?>
					<tr align="center">
											<td><?php echo "<a title='Ver Proyecto' style='color: black;' href='javascript:void(0)' Onclick=\"parent.PRINCIPAL.location.href='frmVistaProyectos.php?id=$proyectos[0]'\">".$proyectos[1]."</a>";?></td>
											<td><?php echo "<a title='Ver Proyecto' style='color: black;' href='javascript:void(0)' Onclick=\"parent.PRINCIPAL.location.href='frmVistaProyectos.php?id=$proyectos[0]'\">".$proyectos[2]."</a>";?></td>
											<td><?php echo "<a title='Ver Proyecto' style='color: black;' href='javascript:void(0)' Onclick=\"parent.PRINCIPAL.location.href='frmVistaProyectos.php?id=$proyectos[0]'\">".$est."</a>";?></td>
											<td><?php echo "<a title='Ver Proyecto' style='color: black;' href='javascript:void(0)' Onclick=\"parent.PRINCIPAL.location.href='frmVistaProyectos.php?id=$proyectos[0]'\">".$proyectos['descripcion']."</a>";?></td>
					</tr>
						<?php
						}
						?>
				...
				<tr>
					...
					<td>
						...
						<img src="../../imagenes/icono_recargar.png" align="top" onClick="redireccionar('frmListaProyectos.php');" onMouseOver="toolTip('Actualizar',this)" class="manita">
