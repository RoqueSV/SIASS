...
function Header()
{
	...
	$this->Ln(20);
	$this->Cell(80);
   	$this->Cell(30,10,'LISTADO DE ALUMNOS QUE HAN FINALIZADO SU SERVICIO SOCIAL.',0,1,'C');
	//SALTO DE LINEA
	$this->Ln(5);
}
...
and ((select coalesce(sum(horas),0) from alumno_proyecto where idalumno=a.idalumno and estadoalumnoproyecto='F' and revision!=3) >=
