...
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td align="center"><h2>ESCUELAS REGISTRADAS</h2>
			  	</td>
			</tr>
<!------------------------------------------------------------------------------------------------------------------------>
			<tr>
				<td>
					...
					?>
					<h3 align="center">Click en una escuela para mas opciones</h3>
					<table align="center" class="marco">
								...
								<table cellpadding="0" cellspacing="0" id="table" class="tinytable">
									<thead class="titulo1">
										<tr>
											...
											<th onMouseOver="toolTip('Ordenar por Instituci&oacute;n',this)" width="85%"><h3>Escuela</h3></th>
										</tr>
									</thead>
									<tbody class="subtitulo2">
										...
										?>
										<tr align="center">
											<td><a title='Ver Documento' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmVerEscuela.php?id=<?php echo $row[0]; ?>'"><?php echo $row['idescuela']; ?></a></td>
											<td><a title='Ver Documento' style='color: black;' href="javascript:void(0)" onclick="parent.PRINCIPAL.location.href='frmVerEscuela.php?id=<?php echo $row[0]; ?>'"><?php echo $row['nombreescuela']; ?></a></td>
										</tr>
										<?php
										}
										?>
						...
						<tr>
							...
							<td>
								...
								<img src="../../imagenes/icono_recargar.png" align="top" onClick="redireccionar('frmConsultarEscuela.php');" onMouseOver="toolTip('Actualizar',this)" class="manita">
					...
					<?php } else{ ?>
					<h2 align="center" class="encabezado2"><img src="../../imagenes/exit.png"><br>NO SE PUDO GENERAR LA LISTA DE ESCUELAS!!</h2>
					<table align="center" class="alerta error centro">
						<tr>
							<td align="center" colspan="3">
									No hay escuelas registradas.<br><br>					
								<img src="../../imagenes/icono_cancelar.png" align="top" onClick="redireccionar('../Inicio/plantilla_pagina.php')" onMouseOver="toolTip('Cancelar, volver al Inicio',this)" class="manita">
							</td>
						</tr>
					</table>
