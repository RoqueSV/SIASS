...
$instruccion = "
SELECT idpropuesta,nomproyecto,nominstitucion 
FROM propuesta_proyecto";

$consulta_propuestas = pg_query($instruccion) or die ("<SPAN CLASS='error'>Fallo en consulta de proyectos!!</SPAN>".pg_last_error());
?>
...
<!------------------------------------------------------------------------------------------------------------------------>
		<tr>
			<td>
			<?php					
			$cantidad_proyectos = pg_query("SELECT count(idpropuesta) FROM propuesta_proyecto") or die ("<SPAN CLASS='error'>Fallo la consulta!!</SPAN>".pg_last_error());
				...
				<tr>
					...
					<tr>
						...
						<tbody class="subtitulo2">
							<?php
							while ($proyectos = pg_fetch_array($consulta_propuestas)){
							?>
					<tr align="center">
											<td><?php echo "<a title='Ver Proyecto' style='color: black;' href='frmVerPropuesta.php?id=$proyectos[0]'>".$proyectos[0]."</a>";?></td>
											<td><?php echo "<a title='Ver Proyecto' style='color: black;' href='frmVerPropuesta.php?id=$proyectos[0]'>".$proyectos[1]."</a>";?></td>
											<td><?php echo "<a title='Ver Proyecto' style='color: black;' href='frmVerPropuesta.php?id=$proyectos[0]'>".$proyectos[2]."</a>";?></td>
						  </tr>
						<?php
						}
						?>
